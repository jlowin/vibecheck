"""The async API: `from vibecheck import check, classify, label, score, ...`."""
...
def check(
    ...
    *,
    ...
    model: str | None = None,
    backend: Backend | None = None,
) -> Pending[Decision[bool | None, float]]: ...
def check(
    question: str,
    data: object = None,
    *,
    ...
    return Pending(
        arun(plan, data, probabilities=probabilities, model=model, backend=backend)
    )
...
def classify(
    ...
    *,
    ...
    model: str | None = None,
    backend: Backend | None = None,
) -> Pending[Decision[T, dict[T, float]]]: ...
def classify(
    question: str,
...
def label(
    ...
    *,
    ...
    model: str | None = None,
    backend: Backend | None = None,
) -> Pending[Decision[list[T], dict[T, float]]]: ...
def label(
    question: str,
    options: Iterable[Any],
    data: object = None,
...
def score(
    ...
    *,
    ...
    model: str | None = None,
    backend: Backend | None = None,
) -> Pending[Decision[float, dict[float, float]]]: ...
def score(
    question: str,
    levels: Iterable[Any],
    data: object = None,
...
def assess(
    ...
    *,
    ...
    model: str | None = None,
    backend: Backend | None = None,
) -> Pending[Decision[M, dict[str, Any]]]: ...
def assess(
    question: str,
    schema: type[Any],
    data: object = None,
...
def filter(
    ...
    *,
    ...
    backend: Backend | None = None,
    max_concurrency: int = DEFAULT_MAX_CONCURRENCY,
) -> Pending[Decision[list[T], list[float]]]: ...
def filter(
    question: str,
    items: Iterable[Any],
    *,
...
def group(
    ...
    *,
    ...
    backend: Backend | None = None,
    max_concurrency: int = DEFAULT_MAX_CONCURRENCY,
) -> Pending[Decision[dict[O, list[T]], list[dict[O, float]]]]: ...
def group(
    question: str,
    options: Iterable[Any],
    items: Iterable[Any],
